...
ENTER 	INY
	...
	INY
	LDA	(IP),Y
	BMI	CLOSURE		; HI-BIT MARKS ENTRY TO A LAMBDA CLOSURE
	ASL
	TAY
	BEQ	+
-	LDA	ESTKH,X
...
CLOSURE
	...
	PHA
	TAY
-	DEC	IPY		; COPY EACH PARAM INTO *TOP* OF FRAME
	BMI	+
	LDA	ESTKH,X
	DEY
	STA	(IFP),Y
	...
	BNE	-
+
-	TYA			; COPY REMAINDER OF ORIGINAL FRAME INTO LAMBDA FRAME
	BEQ	+
	DEY
	LDA	(TMP),Y
	STA	(IFP),Y
